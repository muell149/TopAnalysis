...
IF( DOXYGEN_FOUND )
  ...
  SET (${PROJECT_NAME}_DOC_INSTALL_DIR "${CMAKE_INSTALL_PREFIX}/doc/${PROJECT_NAME}" CACHE STRING "Installation directory for the documentaion")
  MARK_AS_ADVANCED(${PROJECT_NAME}_DOC_INSTALL_DIR)
