...
void crossTriggerIndependentControlTrigRun2011A_IsoEle27_Ele25TriJet(bool save=false)
{
  gStyle->SetOptStat(0);
  ...
  TString outputFileName = "/triggerEffIndpendentControl_SingleMu_Ele25TriJet";
  ...
  char inputPath42b4Synch[]="/afs/naf.desy.de/user/j/jlange/nafscratch/top/CMSSW_4_2_4/src/TopAnalysis/Configuration/analysis/fullLeptonic/beforeSynch";
  ...
  TString methods[100]={ "Summer11 ttbar IsoEle27_Ele25TriJet", "Summer11 WJets IsoEle27_Ele25TriJet", "2011AReRecoV1 IsoEle27_Ele25TriJet", "2011APromptRecoV4 SingleMu_Ele25TriJet", "2011APromptRecoV4 SingleMu_IsoEle25TriJet","2011AReRecoV1 SingleMu_Ele25TriJet NoVetoes", "Summer11 ttbar IsoEle27_Ele25TriJet","2011ReRecoV1 IsoEle27_Ele25TriJet", "2011AReRecoV4 Mu15", "2011PromptV4 Mu15",  "2011APromptV1+2 Mu15", "2011A IsoMu17 MinJet4", "Spring11 MC Mu9", "2011A Mu15", "2011A Mu17emu", "2011A Mu20","2011A IsoMu17","Z genMu match Mu9"};
  TFile* files[100];

  files[0]=new TFile(Form("%s/naf_analyzeCrossTriggerRatiosMCSummer11ttbar_IsoEle27_Ele25TriJet_cfg/analyzeCrossTriggerRatiosMCSummer11ttbar_IsoEle27_Ele25TriJet.root",inputPath42));
  files[1]=new TFile(Form("%s/naf_analyzeCrossTriggerRatiosMCSummer11WJets_IsoEle27_Ele25TriJet_cfg/prel/prel.root",inputPath42));
  files[2]=new TFile(Form("%s/naf_analyzeCrossTriggerRatiosRun2011AV1ReReco_IsoEle27_Ele25TriJet_cfg/analyzeCrossTriggerRatiosRun2011AV1ReReco_IsoEle27_Ele25TriJet.root",inputPath42));


//   files[0]=new TFile(Form("%s/naf_analyzeCrossTriggerRatiosMCSummer11ttbar_All_Ele25TriJet_cfg/analyzeCrossTriggerRatiosMCSummer11ttbar_All_Ele25TriJet.root",inputPath42b4Synch));
//   files[1]=new TFile(Form("%s/naf_analyzeCrossTriggerRatiosRun2011AV4PromptReco_SingleMu_Ele25TriJet_cfg/analyzeCrossTriggerRatiosRun2011AV4PromptReco_SingleMu_Ele25TriJet.root",inputPath42b4Synch));
//   files[2]=new TFile(Form("%s/naf_analyzeCrossTriggerRatiosRun2011AV4PromptReco_SingleMu_IsoEle25TriJet_cfg/analyzeCrossTriggerRatiosRun2011AV4PromptReco_SingleMu_IsoEle25TriJet.root",inputPath42b4Synch));
//   files[3]=new TFile(Form("%s/naf_analyzeCrossTriggerRatiosRun2011AV1ReReco_SingleMu_Ele25TriJet_NoVetoes_cfg/analyzeCrossTriggerRatiosRun2011AV1ReReco_SingleMu_Ele25TriJet_NoVetoes.root",inputPath42b4Synch));
  //files[4]=new TFile(Form("%s/naf_analyzeCrossTriggerRatiosMCSummer11ttbar_IsoEle27_Ele25TriJet_cfg/analyzeCrossTriggerRatiosMCSummer11ttbar_IsoEle27_Ele25TriJet.root",inputPath42b4Synch));
  //files[5]=new TFile(Form("%s/naf_analyzeCrossTriggerRatiosRun2011AV1ReReco_IsoEle27_Ele25TriJet_cfg/analyzeCrossTriggerRatiosRun2011AV1ReReco_IsoEle27_Ele25TriJet.root",inputPath42b4Synch));
  //files[4]=new TFile(Form("%s/naf_analyzeCrossTriggerRatiosRun2011AV1ReReco_SingleMu_Ele25TriJet_cfg/analyzeCrossTriggerRatiosRun2011AV1ReReco_SingleMu_Ele25TriJet.root",inputPath42));
...
for(int iMethod=0; iMethod<methodNum; iMethod++){
 for(int iFolder=0; iFolder<folderNum; iFolder++) {
   ...
   effLeptonRelIso[iMethod]   = (TH1F*) nLeptonRelIso   [iMethod][0]->Clone();
     ...
     effNjets[iMethod]  -> SetTitle("Trigger Efficiency Ele25TriJet30 wrt. IsoEle27 (1 #mu, #geq 4 PF jets)");
     effJetPt[iMethod]     -> SetTitle("Trigger Efficiency Ele25TriJet30 wrt. IsoEle27 (1 #mu, #geq 4 PF jets), 4th jet");
     effJetEta[iMethod]    -> SetTitle("Trigger Efficiency Ele25TriJet30 wrt. IsoEle27 (1 #mu, #geq 4 PF jets), 4th jet");
     effControl[iMethod]-> SetTitle("Trigger Efficiency Ele25TriJet30 wrt. IsoEle27 (1 #mu, #geq 4 PF jets)");
     effLeptonPt[iMethod]     -> SetTitle("Trigger Efficiency Ele25TriJet30 wrt. IsoEle27 (1 #mu, #geq 4 PF jets)");
     effLeptonEta[iMethod]    -> SetTitle("Trigger Efficiency Ele25TriJet30 wrt. IsoEle27 (1 #mu, #geq 4 PF jets)");
     effLeptonRelIso[iMethod]     -> SetTitle("Trigger Efficiency Ele25TriJet30 wrt. IsoEle27 (1 #mu, #geq 4 PF jets)");
