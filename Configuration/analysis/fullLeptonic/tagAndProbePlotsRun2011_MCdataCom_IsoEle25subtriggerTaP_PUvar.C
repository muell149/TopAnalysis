...
void tagAndProbePlotsRun2011_MCdataCom_IsoEle25subtriggerTaP_PUvar(bool save=false)
{
  /// set style
  // ============================
  //  Set ROOT Style
...
//   const int fontstyle1=62;
  ...
  TString outputFolder   = "/afs/desy.de/user/j/jlange/analysis/tagAndProbe/plots/2011/singleEle/Fall11/DataMCcomp_IsoEle25subtriggerTapPUar";
...
//   TString mIDarr []= {"m1-25TriJetPUEPS", "m1-25TriJet", "m1PUEPS", "m1PUele32",   "m3-25TriJetPromptV4", "m3-25TriJet", "m2-32PromptV4", "m2"};
  TString mIDarr []= { "m1-25TriJet", "m1-25TriJetPUup", "m1-25TriJetPUdown",  "m3-25TriJet", "m3-25TriJetPUup", "m3-25TriJetPUdown"};
...
//   bool legOnPlot = false;
  ...
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeMCFall11_IsoEle25subTrigger.root";
  method_["m1-25TriJetPUup"] = new method(fileName, "Simulation IsoEle25 subtrigger PU up", 2, 2, 1, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","eventWeightPUsysUpeventWeightPUUp", "m1-25TriJetPUup");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeMCFall11_IsoEle25subTrigger.root";
  method_["m1-25TriJetPUdown"] = new method(fileName, "Simulation IsoEle25 subtrigger PU down", 3, 2, 1, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","eventWeightPUsysDowneventWeightPUDown", "m1-25TriJetPUdown");
...
//   method_["m2-32WP70B"] = new method(fileName, "2011 Data IsoEle32WP70 B", 1, 1, 26, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run>178380");
  ...
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011PostEPS_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeRun2011All_IsoEle25subTrigger.root";
  method_["m3-25TriJetPUup"] = new method(fileName, "2011 Data IsoEle25 subtrigger PU up", 1, 6, 21, 6, "E", "PL", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","","m1-25TriJetPUup");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011PostEPS_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeRun2011All_IsoEle25subTrigger.root";
  method_["m3-25TriJetPUdown"] = new method(fileName, "2011 Data IsoEle25 subtrigger PU down", 1, 8, 22, 8, "E", "PL", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","","m1-25TriJetPUdown");
  ...
  method_["m3-25TriJetPromptV4"] = new method(fileName, "Run PromptV4 CiC IsoEle25subTrig only TriJet", 1, 4, 24, 4, "E", "PL", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run>165088 && run<=167913","","m1-25TriJetPUEPS");
