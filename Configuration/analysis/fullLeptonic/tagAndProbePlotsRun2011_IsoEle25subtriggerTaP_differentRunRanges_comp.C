...
void tagAndProbePlotsRun2011_IsoEle25subtriggerTaP_differentRunRanges_comp(bool save=false)
{
  /// set style
  // ============================
  //  Set ROOT Style
...
//   const int fontstyle1=62;
  ...
  TString outputFolder   = "/afs/desy.de/user/j/jlange/analysis/tagAndProbe/plots/2011/singleEle/Fall11/IsoEle25_differentRunRangesComp";
  TString outputFileName = "/IsoEle25_differentRunRangesComp_";
...
//   TString mIDarr []= {"m1PUele32", "m1-25", "m1-25TriJet", "m2-32EPS", "m2-32ApostEPS", "m2-32B", "m3-25PromptV4", "m3-25TriJetPromptV4"};
 // TString mIDarr []= {"m1PUele32", "m1-25TriJet", "m2-32EPS", "m2-32ApostEPS", "m2-32B", "m3-25TriJetPromptV4", "m3-25TriJetApostEPS", "m3-25TriJetB3e33", "m3-25TriJetB5e33"};
  ...
  TString mIDarr []= {"m1-25TriJet", "m3-25TriJet", "m3-nonIso25TriJetPromptV4", "m3-25TriJetPromptV4", "m3-25TriJetApostEPS", "m3-25TriJetB3e33", "m3-25TriJetB5e33"};
...
//   bool legOnPlot = false;
  ...
  method_["m1"] = new method(fileName, "Simulation IsoEle32", 1, 2, 1, 1, "E", "L", "treeV2","probePt>37. && TMath::Abs(probeEta)<2.1","eventWeightPUeventWeightPU");
  ...
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet.root";
  method_["m1PUEPS"] = new method(fileName, "Fall11 CiC IsoEle32 PUrew EPS", 3, 8, 1, 1, "E", "L", "treeV2","probePt>37. && TMath::Abs(probeEta)<2.1","eventWeightPUEPSeventWeightPUEPS", "m1PUEPS");
  ...
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeMCFall11_IsoEle25subTrigger.root";
  method_["m1-25TriJetPUEPS"] = new method(fileName, "Simulation IsoEle25 trig with TriJet PU EPS", 3, 4, 1, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","eventWeightPUEPSeventWeightPUEPS");
...
//   method_["m2-32WP70B"] = new method(fileName, "2011 Data IsoEle32WP70 B", 1, 1, 26, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run>178380");
  ...
  fileName=inputPath428+"/scratchFullLeptonic/prel/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
  method_["m2-32PromptV4"] = new method(fileName, "Run PromptV4 CiC IsoEle32", 1, 1, 23, 1, "E", "PL", "treeV2","probePt>37. && TMath::Abs(probeEta)<2.1 && run>165088 && run<=167913","","m1PUEPS");
  ...
  method_["m3-25TriJet"] = new method(fileName, "2011 Data All IsoEle25 subtrigger", 1, 1, 20, 1, "E", "PL", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","");
  ...
  method_["m3-nonIso25TriJetPromptV4"] = new method(fileName, "PromptV4 Ele25 subtrigger", 1, 7, 28, 7, "E", "PL", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run>165088 && run<=167913");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011APromptV4_HLT_IsoEle25subTrigger_cfg/prel.root";
  method_["m3-25TriJetPromptV4"] = new method(fileName, "PromptV4 IsoEle25 subtrigger", 1, 4, 21, 4, "E", "PL", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run>165088 && run<=167913","");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011PostEPS_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeRun2011All_IsoEle25subTrigger.root";
  method_["m3-25TriJetApostEPS"] = new method(fileName, "Run A post EPS IsoEle25 subtrigger", 1, 4, 25, 4, "E", "PL", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1  && run>167913 && run<=175570");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011PostEPS_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeRun2011All_IsoEle25subTrigger.root";
  method_["m3-25TriJetB3e33"] = new method(fileName, "Run B 3e33 IsoEle25 subtrigger", 1, 6, 22, 6, "E", "PL", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run>175570 && run<=178380");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011PostEPS_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeRun2011All_IsoEle25subTrigger.root";
  method_["m3-25TriJetB5e33"] = new method(fileName, "Run B 5e33 IsoEle25 subtrigger", 1, 6, 26, 6, "E", "PL", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run>178380 && run<=180252");
