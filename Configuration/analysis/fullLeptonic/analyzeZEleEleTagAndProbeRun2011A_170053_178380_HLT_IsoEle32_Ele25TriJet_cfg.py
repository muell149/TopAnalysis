...
##~1550 files
process.load("TopAnalysis/Configuration/samples/Run2011A_SingleEle_Aug05ReReco_PromptRecoV6_2011B_3e33_AOD_cff")

# change second triggers!!!!
process.hltTriggerFilter2.HLTPaths = ["HLT_Ele25_CaloIdVT_TrkIdT_CentralTriJet30_v*",
    "HLT_Ele25_CaloIdVT_TrkIdT_TriCentralJet30_v*", "HLT_Ele25_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_TriCentralJet30_v*"]
...
if(jsonFile==''):
    ...
    #print "lumisToProcess = ", process.source.lumisToProcess
process.TFileService.fileName = 'analyzeZEleEleTagAndProbeRun2011AB_170053_178380_HLT_IsoEle32_IsoEle25TriJet.root'
