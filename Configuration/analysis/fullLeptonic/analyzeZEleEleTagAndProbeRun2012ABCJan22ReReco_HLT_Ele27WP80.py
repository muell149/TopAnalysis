...
##  22,400 files
process.load("TopAnalysis/Configuration/samples/SingleElectron_Run2012ABCJan22ReReco_cff")
...
if(jsonFile==''):
    ...
    #print "lumisToProcess = ", process.source.lumisToProcess
process.TFileService.fileName = 'analyzeZEleEleTagAndProbeRun2012ABCJan22ReReco_HLT_Ele27WP80.root'
