...
void tagAndProbePlotsRun2011AIsoMu17or24DifferentRunRanges(bool save=false)
{
  gStyle->SetOptStat(0);
  ...
  TString outputFolder   = "/afs/desy.de/user/j/jlange/analysis/tagAndProbe/plots/2011/singleMu/PF2PAT/IsoMu17or24DifferentRunRanges";
  TString outputFileName = "/IsoMu17or24DifferentRunRanges_";
...
//    method_["m1"] = new method(fileName, "Summer11 IsoMu17", 1, 2, 1, 2, "", "L","histo");
  ...
  method_["m1"] = new method(fileName, "IsoMu17 5e32", 1, 1, 20, 1, "E0", "P","histo");
  ...
  fileName=inputPathScratch+"/naf_analyzeZMuMuTagAndProbeRun2011A_1e33_165088_167913_HLT_IsoMu17_IsoMu17TriJet_muPt30_cfg/analyzeZMuMuTagAndProbeRun2011A_1e33_165088_167913_HLT_IsoMu17_IsoMu17TriJet_muPt30.root";
   method_["m2"] = new method(fileName, "IsoMu17 1e33", 1, 2, 21, 2, "E0 same", "P","histo");
   ...
   method_["m3"] = new method(fileName, "IsoMu24 2e33", 1, 4, 22, 4, "E0 same", "P","histo");
   ...
   method_["m4"] = new method(fileName, "IsoMu24 3e33", 1, 8, 23, 8, "E0 same", "P","histo");
...
//   TString foldersTitle[]={"Trigger"};
  ...
  for(int iFolder=0; iFolder < folderNum; iFolder++){
    ...
    eff_["PVMult"][folderID[iFolder]]          =new eff("PVMult", cutPtEta, mBinsPVMult, binsPVMult_, title, yLo, yHi,0.,30.);
