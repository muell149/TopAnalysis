...
void tagAndProbePlotsRun2011_MCdataCom_IsoMu17_IsoMu24_differentPU(bool save=false)
{
  /// set style
  // ============================
  //  Set ROOT Style
...
//   const int fontstyle1=62;
  ...
  TString outputFolder   = "/afs/desy.de/user/j/jlange/analysis/tagAndProbe/plots/2011/singleMu/Fall11/DataMCcomp_IsoMu17-24_differentPUnormalisedData";
  TString outputFileName = "/DataMCcomp_IsoMu17-24_differentPUnormalisedData_";
...
//   bool legOnPlot = false;
  ...
  ///---------------------------------------------------------------------------
  /// to compare different MC PU scenaria and data, normalised to central PU:
   /// Fall11 MC
...
//   method_["m1"] = new method(fileName, "Fall11 IsoMu24eta2p1 PUrew", 1, 2, 1, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","eventWeightPUeventWeightPU");
//   
//   fileName=inputPath428+"/naf_analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17TriJet_cfg/analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17eta2p1TriJet.root";
//   method_["m1noPU"] = new method(fileName, "Fall11 IsoMu24eta2p1 no PUrew", 2, 2, 1, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","");
//   
//   fileName=inputPath428+"/naf_analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17TriJet_cfg/analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17eta2p1TriJet.root";
//   method_["m1PUEPS"] = new method(fileName, "Fall11 IsoMu24eta2p1 PUrew EPS", 1, 7, 1, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","eventWeightPUEPSeventWeightPUEPS");
//   
//   fileName=inputPath428+"/naf_analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17TriJet_cfg/analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17eta2p1TriJet.root";
//   method_["m1PUup"] = new method(fileName, "Fall11 IsoMu24eta2p1 PUrew UP", 1, 4, 1, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","eventWeightPUsysUpeventWeightPUUp");
//   
//   fileName=inputPath428+"/naf_analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17TriJet_cfg/analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17eta2p1TriJet.root";
//    method_["m1PUdown"] = new method(fileName, "Fall11 IsoMu24eta2p1 PUrew DOWN", 1, 8, 1, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","eventWeightPUsysDowneventWeightPUDown");
//   
//   /// data
...
//   method_["m2"] = new method(fileName, "2011 Data IsoMu17/24/eta2p1", 1, 1, 21, 1, "E", "LP", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1");
  
    ///---------------------------------------------------------------------------
  /// to compare different MC PU scenaria and data, normalised to different PU scenaria:
   /// Fall11 MC
  fileName=inputPath428+"/naf_analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17TriJet_cfg/analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17eta2p1TriJet.root";
  method_["m1"] = new method(fileName, "Fall11 IsoMu24eta2p1 PUrew", 1, 2, 1, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","eventWeightPUeventWeightPU","m1");
  
  fileName=inputPath428+"/naf_analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17TriJet_cfg/analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17eta2p1TriJet.root";
  method_["m1PUup"] = new method(fileName, "Fall11 IsoMu24eta2p1 PUrew UP", 1, 2, 1, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","eventWeightPUsysUpeventWeightPUUp","m1PUup");
  
  fileName=inputPath428+"/naf_analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17TriJet_cfg/analyzeZMuMuTagAndProbeMCFall11_HLT_IsoMu24_eta2p1_IsoMu17eta2p1TriJet.root";
  method_["m1PUdown"] = new method(fileName, "Fall11 IsoMu24eta2p1 PUrew DOWN", 1, 2, 1, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","eventWeightPUsysDowneventWeightPUDown","m1PUdown");
  
  /// data
  fileName=inputPath428+"/naf_analyzeZMuMuTagAndProbeRun2011All_HLT_IsoMu17_24_IsoMu17TriJet_cfg/analyzeZMuMuTagAndProbeRun2011All_HLT_IsoMu17_24_IsoMu17TriJet.root";
  method_["m2"] = new method(fileName, "2011 Data IsoMu17/24/eta2p1", 1, 1, 21, 1, "E", "LP", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","","m1");
  
  fileName=inputPath428+"/naf_analyzeZMuMuTagAndProbeRun2011All_HLT_IsoMu17_24_IsoMu17TriJet_cfg/analyzeZMuMuTagAndProbeRun2011All_HLT_IsoMu17_24_IsoMu17TriJet.root";
  method_["m2PUup"] = new method(fileName, "2011 Data IsoMu17/24/eta2p1 PU up", 1, 1, 24, 1, "E", "LP", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","","m1PUup");
  
  fileName=inputPath428+"/naf_analyzeZMuMuTagAndProbeRun2011All_HLT_IsoMu17_24_IsoMu17TriJet_cfg/analyzeZMuMuTagAndProbeRun2011All_HLT_IsoMu17_24_IsoMu17TriJet.root";
  method_["m2PUdown"] = new method(fileName, "2011 Data IsoMu17/24/eta2p1 PU down", 1, 1, 26, 1, "E", "LP", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1","","m1PUdown");
...
//   effRelIso[iMethod][iFolder]->GetXaxis()->SetNdivisions(505);
  ...
  if(save){
    ...
    TFile f("MuonEffSF2011.root", "recreate");
    ...
    std::cout<<"MuonEffSF2011.root with TGraphErrors is saved in "<<outputFolder<<std::endl;
  }
