...
void tagAndProbePlotsRun2011A_MCdataCom_IsoMu17or24(bool save=false)
{
  gStyle->SetOptStat(0);
  ...
  TString outputFolder   = "/afs/desy.de/user/j/jlange/analysis/tagAndProbe/plots/2011/singleMu/PF2PAT/IsoMu17or24MCdataComp";
  TString outputFileName = "/IsoMu17or24MCdataComp_";
...
//   bool legOnPlot = false;
  ...
  method_["m1"] = new method(fileName, "Summer11 IsoMu17 PUrew", 1, 2, 1, 2, "", "L","histo");
   
   fileName=inputPathScratch+"/naf_analyzeZMuMuTagAndProbeMCSummer11_HLT_IsoMu17_Mu17TriJet_muPt30_PUrewEPS_cfg/analyzeZMuMuTagAndProbeMCSummer11_HLT_IsoMu17_Mu17TriJet_muPt30_PUrewEPS.root";
   method_["m2"] = new method(fileName, "Summer11 IsoMu17 no PUrew", 2, 2, 1, 2, "E same", "L","tree");
   
   fileName=inputPathScratch+"/naf_analyzeZMuMuTagAndProbeMCSummer11_HLT_IsoMu17_Mu17TriJet_muPt30_PUrewEPS_cfg/analyzeZMuMuTagAndProbeMCSummer11_HLT_IsoMu17_Mu17TriJet_muPt30_PUrewEPS.root";
   method_["m2b"] = new method(fileName, "Summer11 IsoMu17 PUrew tree", 3, 2, 1, 2, "E same", "L","treeWeight");
...
//   method_["m2"] = new method(fileName, "Summer11 IsoMu24 PUrew histo", 2, 2, 1, 2, "E same", "L", "histo");
    
  fileName=inputPathScratch+"/naf_analyzeZMuMuTagAndProbeRun2011A_160404_167913_HLT_IsoMu17_IsoMu17TriJet_muPt30_cfg/analyzeZMuMuTagAndProbeRun2011AEPS_160404_167913_HLT_IsoMu17_IsoMu17TriJet_muPt30.root";
  method_["m3"] = new method(fileName, "IsoMu17 2011A EPS", 1, kGreen+2, 20, kGreen+2, "E X0 same", "P","histo");
  
  fileName=inputPathScratch+"/naf_analyzeZMuMuTagAndProbeRun2011ApostEPS_170826_175770_HLT_IsoMu24Eta_IsoMu17EtaTriJet_muPt30_cfg/analyzeZMuMuTagAndProbeRun2011ApostEPS_170826_175770_HLT_IsoMu24Eta_IsoMu17EtaTriJet_muPt30.root";
   method_["m4"] = new method(fileName, "IsoMu24 2011A postEPS", 1, 4, 21, 4, "E X0 same", "P","histo");
   
   fileName=inputPathScratch+"/naf_analyzeZMuMuTagAndProbeRun2011A_all_160404_175770_HLT_IsoMu17or24_IsoMu17TriJet_muPt30_cfg/analyzeZMuMuTagAndProbeRun2011Aall_160404_175770_HLT_IsoMu17or24_IsoMu17TriJet_muPt30.root";
   method_["m5"] = new method(fileName, "IsoMu17/24 2011A all", 1, 1, 22, 1, "E X0 same", "P","histo");
