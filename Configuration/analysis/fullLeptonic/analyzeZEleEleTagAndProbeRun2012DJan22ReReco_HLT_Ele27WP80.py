...
##  22,400 files
process.load("TopAnalysis/Configuration/samples/SingleElectron_Run2012DJan22ReReco_onlyValid_cff")
...
if(jsonFile==''):
    ...
    #print "lumisToProcess = ", process.source.lumisToProcess
process.TFileService.fileName = 'analyzeZEleEleTagAndProbeRun2012DJan22ReReco_HLT_Ele27WP80.root'
