...
##823
process.load("TopAnalysis/Configuration/samples/Run2011A_SingleEle_PromptRecoV4_AOD_cff")
...
if(jsonFile==''):
    ...
    #print "lumisToProcess = ", process.source.lumisToProcess
process.TFileService.fileName = 'analyzeZEleEleTagAndProbeRun2011A_165088_167913_HLT_IsoEle32_IsoEle25TriJet.root'
