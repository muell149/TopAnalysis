...
void tagAndProbePlotsRun2011_MCdataCom_IsoEle27_IsoEle32(bool save=false)
{
  /// set style
  // ============================
  //  Set ROOT Style
...
//   bool legOnPlot = false;
  ...
  /// option to select different cuts for Ele25 and 32:
  /// select pt<30 always for Ele25 and for Ele32 for selection efficiency
  /// slect pt<37 for Ele32 for trigger efficiency to be 5 pt above threshold
  TCut cutEle25 = "probePt>30. && TMath::Abs(probeEta)<2.1";
  TCut cutEle32 = "probePt>30. && TMath::Abs(probeEta)<2.1";
  ...
  method_["m1"] = new method(fileName, "Simulation IsoEle32", 1, 2, 1, 1, "E", "L", "treeV2",cutEle32,"eventWeightPUeventWeightPU");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet.root";
  method_["m1PUele32"] = new method(fileName, "Simulation IsoEle32", 2, 2, 1, 1, "E", "L", "treeV2",cutEle32,"eventWeightPUEle32eventWeightPUEle32", "m1PUele32");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet.root";
  method_["m1PUele32inclWp70"] = new method(fileName, "Fall11 CiC IsoEle32 PUrew Ele32 incl WP70", 2, 2, 1, 1, "E", "L", "treeV2",cutEle32,"eventWeightPUEle32WP70eventWeightPUEle32WP70");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet.root";
  method_["m1PUB"] = new method(fileName, "Fall11 CiC IsoEle32 PUrew B", 3, 8, 1, 1, "E", "L", "treeV2",cutEle32,"eventWeightPU2011BeventWeightPU2011B");
  
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet.root";
  method_["m1noPU"] = new method(fileName, "Fall11 IsoEle32 no PUrew", 2, 2, 1, 1, "E", "L", "treeV2",cutEle32,"");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet.root";
  method_["m1PUEPS"] = new method(fileName, "Fall11 CiC IsoEle32 PUrew EPS", 3, 8, 1, 1, "E", "L", "treeV2",cutEle32,"eventWeightPUEPSeventWeightPUEPS", "m1PUEPS");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet.root";
  method_["m1PUup"] = new method(fileName, "Fall11 IsoEle32 PUrew UP", 2, 4, 1, 1, "E", "L", "treeV2",cutEle32,"eventWeightPUsysUpeventWeightPUUp");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle32_IsoEle25TriJet.root";
  method_["m1PUdown"] = new method(fileName, "Fall11 IsoEle32 PUrew DOWN", 2, 7, 1, 1, "E", "L", "treeV2",cutEle32,"eventWeightPUsysDowneventWeightPUDown");
  ...
  method_["m1-424"] = new method(fileName, "Summer11 WP70 IsoEle32 PUw", 2, 4, 1, 4, "E same", "LP","treeV2",cutEle32,"PUweightEPSeventWeightPU");
  ...
  method_["m1-25"] = new method(fileName, "Simulation IsoEle25 trigs with all jet mult.", 2, 4, 1, 1, "E", "L", "treeV2",cutEle25,"eventWeightPUEPSeventWeightPUEPS");
  ...
  method_["m1-25TriJet"] = new method(fileName, "Simulation IsoEle25 subtrigger", 1, 2, 1, 1, "E", "L", "treeV2",cutEle25,"eventWeightPUeventWeightPU", "m1-25TriJet");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeMCFall11_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeMCFall11_IsoEle25subTrigger.root";
  method_["m1-25TriJetPUEPS"] = new method(fileName, "Simulation IsoEle25 trig with TriJet PU EPS", 3, 4, 1, 1, "E", "L", "treeV2",cutEle25,"eventWeightPUEPSeventWeightPUEPS");
...
//   method_["m2"] = new method(fileName, "Data IsoEle27/32", 1, 1, 21, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run<=178380");
//   
//   fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
//   method_["m2-27"] = new method(fileName, "Data IsoEle27, run<=161176", 1, 1, 22, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run<=161176");
//   
//   fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
//   method_["m2-32EPS"] = new method(fileName, "Data IsoEle32 EPS", 1, 1, 23, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run>161176 && run<=167913");
//   
//   fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
//   method_["m2-32ApostEPS"] = new method(fileName, "Data IsoEle32 A post EPS", 1, 1, 24, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run>167913 && run<=175570");
//   
//   fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
//   method_["m2-32B"] = new method(fileName, "Data IsoEle32 B", 1, 1, 25, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run>175570 && run<=178380");
//   
//   fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
//   method_["m2-32WP70B"] = new method(fileName, "Data IsoEle32WP70 B", 1, 1, 26, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1 && run>178380");
  
  fileName=inputPath428+"/scratchFullLeptonic/prel/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
  method_["m2"] = new method(fileName, "Data IsoEle27/32", 1, 1, 24, 1, "E", "PL", "treeV2",cutEle32 && "run<=178380", "", "m1PUele32");
  
  fileName=inputPath428+"/scratchFullLeptonic/prel/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
  method_["m2-27"] = new method(fileName, "Data IsoEle27, run<=161176", 1, 1, 22, 1, "E", "PL", "treeV2",cutEle32 && "run<=161176");
  
  fileName=inputPath428+"/scratchFullLeptonic/prel/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
  method_["m2-32EPS"] = new method(fileName, "Data CiC EPS IsoEle32", 1, 1, 23, 1, "E", "PL", "treeV2",cutEle32 && "run>161176 && run<=167913");
  
  fileName=inputPath428+"/scratchFullLeptonic/prel/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
  method_["m2-32PromptV4"] = new method(fileName, "Run PromptV4 CiC IsoEle32", 1, 1, 23, 1, "E", "PL", "treeV2",cutEle32 && "run>165088 && run<=167913","","m1PUEPS");
  ...
  method_["m2-32PromptV4-424"] = new method(fileName, "Run PromptV4 WP70 EPS IsoEle32", 2, 4, 25, 4, "E same", "LP","treeV2",cutEle32 && "run>165088 && run<=167913","");
  
  fileName=inputPath428+"/scratchFullLeptonic/prel/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
  method_["m2-32ApostEPS"] = new method(fileName, "Data IsoEle32 A post EPS", 1, 1, 24, 1, "E", "PL", "treeV2",cutEle32 && "run>167913 && run<=175570");
  
  fileName=inputPath428+"/scratchFullLeptonic/prel/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
  method_["m2-32B"] = new method(fileName, "Data IsoEle32 B", 1, 1, 25, 1, "E", "PL", "treeV2",cutEle32 && "run>175570 && run<=178380");
  
  fileName=inputPath428+"/scratchFullLeptonic/prel/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
  method_["m2-32WP70B"] = new method(fileName, "Data IsoEle32WP70 B", 1, 1, 26, 1, "E", "PL", "treeV2",cutEle32 && "run>178380");

  
  fileName=inputPath428+"/scratchFullLeptonic/prel/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
  method_["m2-32EPS35"] = new method(fileName, "Data IsoEle32 EPS >35 GeV", 1, 8, 23, 8, "E", "PL", "treeV2","probePt>35. && TMath::Abs(probeEta)<2.1 && run>161176 && run<=167913");
  
  fileName=inputPath428+"/scratchFullLeptonic/prel/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
  method_["m2-32ApostEPS35"] = new method(fileName, "Data IsoEle32 A post EPS >35 GeV", 1, 8, 24, 8, "E", "PL", "treeV2","probePt>35. && TMath::Abs(probeEta)<2.1 && run>167913 && run<=175570");
  
  fileName=inputPath428+"/scratchFullLeptonic/prel/analyzeZEleEleTagAndProbeRun2011All_HLT_IsoEle27_32_IsoEle25TriJet.root";
  method_["m2-32B35"] = new method(fileName, "Data IsoEle32 B >35 GeV", 1, 8, 25, 8, "E", "PL", "treeV2","probePt>35. && TMath::Abs(probeEta)<2.1 && run>175570 && run<=178380");
  ...
  method_["m3-25TriJet"] = new method(fileName, "Data IsoEle25 subtrigger", 1, 1, 20, 1, "E", "PL", "treeV2",cutEle25,"","m1-25TriJet");
  ...
  method_["m3-nonIso25TriJetPromptV4"] = new method(fileName, "Run PromptV4 CiC Ele25subTrig only TriJet", 1, 4, 28, 4, "E", "PL", "treeV2",cutEle25 && "run>165088 && run<=167913");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011APromptV4_HLT_IsoEle25subTrigger_cfg/prel.root";
  method_["m3-25TriJetPromptV4"] = new method(fileName, "Run PromptV4 CiC IsoEle25subTrig only TriJet", 1, 4, 24, 4, "E", "PL", "treeV2",cutEle25 && "run>165088 && run<=167913","","m1-25TriJetPUEPS");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011PostEPS_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeRun2011All_IsoEle25subTrigger.root";
  method_["m3-25TriJetApostEPS"] = new method(fileName, "Run A post EPS CiC IsoEle25subTrig only TriJet", 1, 4, 25, 4, "E", "PL", "treeV2",cutEle25  && "run>167913 && run<=175570");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011PostEPS_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeRun2011All_IsoEle25subTrigger.root";
  method_["m3-25TriJetB3e33"] = new method(fileName, "Run B 3e33 CiC IsoEle25subTrig only TriJet", 1, 6, 26, 6, "E", "PL", "treeV2",cutEle25 && "run>175570 && run<=178380");
  
  fileName=inputPath428+"/naf_analyzeZEleEleTagAndProbeRun2011PostEPS_HLT_IsoEle25subTrigger_cfg/analyzeZEleEleTagAndProbeRun2011All_IsoEle25subTrigger.root";
  method_["m3-25TriJetB5e33"] = new method(fileName, "Run B 5e33 CiC IsoEle25subTrig only TriJet", 1, 6, 27, 6, "E", "PL", "treeV2",cutEle25 && "run>178380 && run<=180252");
