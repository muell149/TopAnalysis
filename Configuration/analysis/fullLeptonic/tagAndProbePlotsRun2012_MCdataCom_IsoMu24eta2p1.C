...
//   const int fontstyle1=62;
  ...
  TString inputPath533      ="/afs/naf.desy.de/user/j/jlange/nafscratch/top/CMSSW_5_3_5/src/TopAnalysis/Configuration/analysis/fullLeptonic";
...
//  TString outputFolder   = "/afs/desy.de/user/j/jlange/analysis/tagAndProbe/plots/2011/singleMu/Fall11/DataMCcomp_IsoMu17-24_relIsoL0p2";
   ...
   TString outputFileName = "/DataMCcomp_IsoMu24_";
...
//   bool legOnPlot = false;
  ...
  /// Constructor for struct method(TString iniFileName, TString iniLegName, int iniLineStyle, int iniLineColor, int iniMarkerStyle, int iniMarkerColor, TString iniDrawOpt, TString iniLepOpt, TString source)
   ...
   /// Fall11 MC
  fileName=inputPathDust+"/20121218T202728_naf_analyzeZMuMuTagAndProbeMCSummer12_HLT_IsoMu24_eta2p1COPY/prel.root";
...
//   
  /// data
  fileName=inputPathDust+"/20121218T202728_naf_analyzeZMuMuTagAndProbeMCSummer12_HLT_IsoMu24_eta2p1COPY/prel.root";
  method_["m2"] = new method(fileName, "Data IsoMu17(24)(eta2p1)", 1, 1, 21, 1, "E", "L", "treeV2","probePt>30. && TMath::Abs(probeEta)<2.1");
