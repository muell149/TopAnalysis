...
jsonFile = "../semiLeptonic/diffXSection/Cert_190456-208686_8TeV_22Jan2013ReReco_Collisions12_JSON.txt"
...
##  22,400 files
process.load("TopAnalysis/Configuration/samples/SingleElectron_Run2012ABCDJan22ReReco_onlyValid_cff")
...
if(jsonFile==''):
    ...
    #print "lumisToProcess = ", process.source.lumisToProcess
process.TFileService.fileName = 'analyzeZEleEleTagAndProbeRun2012ABCDJan22ReReco_HLT_Ele27WP80.root'
