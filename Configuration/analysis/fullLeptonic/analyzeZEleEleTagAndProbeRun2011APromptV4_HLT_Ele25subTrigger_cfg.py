...
filterPathSelector  = "hltEle25CaloIdVTTrkIdTDphiFilter"
...
## 1431 files
process.load("TopAnalysis/Configuration/samples/Run2011A_ElectronHadPromptRecoV4_AOD_cff")
...
process.hltTriggerFilter.HLTPaths = ["HLT_Ele25_CaloIdVT_TrkIdT_TriCentralJet30_v*"]
...
if(jsonFile==''):
    ...
    #print "lumisToProcess = ", process.source.lumisToProcess
process.TFileService.fileName = 'analyzeZEleEleTagAndProbeRun2011APromptV4_Ele25subTrigger.root'
