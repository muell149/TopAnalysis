...
## ~ 19,000 files
process.load("TopAnalysis/Configuration/samples/SingleMu_Run2012ABCDJan22ReReco_cff")
...
if(jsonFile==''):
    ...
    #print "lumisToProcess = ", process.source.lumisToProcess
process.TFileService.fileName = 'analyzeZMuMuTagAndProbeRun2012ABCDJan22ReReco_HLT_IsoMu24eta2p1.root'
