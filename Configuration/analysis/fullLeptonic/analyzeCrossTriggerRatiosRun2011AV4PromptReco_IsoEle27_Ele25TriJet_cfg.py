...
triggerPathSelector2 = "HLT_Ele25_CaloIdVT_TrkIdT_TriCentralTri30_v*"
...
process.load("TopAnalysis.Configuration.samples.Run2011A_SingleEle_PromptRecoV4_AOD_Trig1_cff")
# Lumi range
...
process.TFileService.fileName = 'analyzeCrossTriggerRatiosRun2011AV4PromptReco_IsoEle27_Ele25TriJet.root'
