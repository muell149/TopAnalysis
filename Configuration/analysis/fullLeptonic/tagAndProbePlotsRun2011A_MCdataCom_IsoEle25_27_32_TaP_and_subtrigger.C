...
void tagAndProbePlotsRun2011A_MCdataCom_IsoEle25_27_32_TaP_and_subtrigger(bool save=false)
{
  ...
  TString outputFolder   = "/afs/desy.de/user/j/jlange/analysis/tagAndProbe/plots/2011/singleEle/IsoEle25-27-32Comp";
  TString outputFileName = "/IsoEle25-27-32Comp_";
//   TString outputFileName = "/IsoEle27-32_5GeVaboveThresholdInclCombinedData";
  ...
  TString mIDarr []= {"m1", "m5", "refTr1", "refTr2"};
...
//   bool legOnPlot = false;
  ...
  method_["m1"] = new method(fileName, "Summer11 IsoEle27, p_{T}>32GeV", 1, 2, 1, 2, "E same", "LP","treeV2","probePt>32.","PUweightEPSeventWeightPU");
...
//   
// //   fileName=inputPath42+"/naf_analyzeZEleEleTagAndProbeRun2011A_160404_163869_HLT_IsoEle27_Ele25TriJet_cfg/analyzeZEleEleTagAndProbeRun2011A_160404_163869_HLT_IsoEle27_IsoEle25TriJet.root";
// //   method_["m2"] = new method(fileName, "Run May10 IsoEle27", 1, 2, 21, 2, "E same", "LP","treeV2","","");
// //   
//   fileName=inputPath42+"/naf_analyzeZEleEleTagAndProbeMCSummer11_HLT_IsoEle32_IsoEle25TriJet_cfg/analyzeZEleEleTagAndProbeMCSummer11_HLT_IsoEle32_IsoEle25TriJet.root";
//   method_["m3"] = new method(fileName, "Summer11 IsoEle32", 2, 4, 1, 4, "E same", "LP","treeV2","","PUweightEPSeventWeightPU");
// //   
// //   fileName=inputPath42+"/naf_analyzeZEleEleTagAndProbeRun2011A_165088_167913_HLT_IsoEle32_Ele25TriJet2_cfg/analyzeZEleEleTagAndProbeRun2011A_165088_167913_HLT_IsoEle32_IsoEle25TriJet.root";
...
//   
  ...
  method_["refTr2"] = new method(fileName, "Run PromptV4 IsoEle25", 2, 8, 21, 8, "E same", "LP","treeV2","","");
...
//   TString effIDarr[]      = {"Control", "Pt", "Eta", "RelIso", "PVMult", "Mult", "MinDR","lepLepMass"};
  ...
  for(int iFolder=0; iFolder < folderNum; iFolder++){
    ...
    eff_["Pt"][folderID[iFolder]]             =new eff("Pt", cutEta, mBinsPt, binsPt_, title, yLo, yHi, 30.,150.,true);
