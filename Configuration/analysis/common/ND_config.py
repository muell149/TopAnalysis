...
op_inputScript = 'TopAnalysis.Configuration.Summer12.TTH_Inclusive_M_125_8TeV_pythia6_Summer12_DR53X_PU_S10_START53_V7A_v1_cff'#
...
process.pfIsolatedMuons.isolationValueMapsCharged = [cms.InputTag("muPFIsoValueCharged04")]
process.pfIsolatedMuons.isolationValueMapsNeutral = [cms.InputTag("muPFIsoValueNeutral04"), cms.InputTag("muPFIsoValueGamma04")]
...
outfile = open('dumpedConfigND.py','w'); print >> outfile,process.dumpPython(); outfile.close()
