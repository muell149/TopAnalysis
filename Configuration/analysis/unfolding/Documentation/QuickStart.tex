...
\begin{itemize}
\item Uni-HH functions: \url{http://cmssw.cvs.cern.ch/cgi-bin/cmssw.cgi/UserCode/Bromo/TopAnalysis/Configuration/analysis/unfolding/}
\item Unfolding Code: \url{http://cmssw.cvs.cern.ch/cgi-bin/cmssw.cgi/UserCode/Bromo/TopAnalysis/Configuration/analysis/semiLeptonic/diffXSection}
\end{itemize}
\end{itemize}
...
\begin{itemize}
\item Name of the ROOT file to contain all control plots.
...
\lyxframeend{}\lyxframe{Step 3: Steering Options}
\begin{itemize}
...
\begin{itemize}
\item Check out steering options 10 and 11 
\end{itemize}
\item Do you need to adapt the number of scan points or the scan range?

\begin{itemize}
\item Check out steering options 8 and 9
\end{itemize}
\item What normalization is right for you?

\begin{itemize}
\item Check out steering option 13
\end{itemize}
\item Need the results in different formats?

\begin{itemize}
\item Check out steering options 4, 5, 6 and 17
\end{itemize}
\end{itemize}
...
\begin{itemize}
\item set 'numSys' to 2 and ...
\item let all pointer type parameters be arrays of length 3 (except data
distribution and total data event count).
