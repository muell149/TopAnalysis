...
/**********************************************************************************
 *                                                                                *
 * Project: TopSVDUnfold - data unfolding based on Singular Value Decomposition     *
 * Package: ROOT                                                                  *
 * Class  : TopSVDUnfold                                                            *
 *                                                                                *
 * Description:                                                                   *
...
<p>
TopSVDUnfold implements the singular value decomposition based unfolding method (see reference). Currently, the unfolding of one-dimensional histograms is supported, with the same number of bins for the measured and the unfolded spectrum.
<p>
...
<ul>
<pre>
TopSVDUnfold *tsvdunf = new TopSVDUnfold( bdat, Bcov, bini, xini, Adet );
...
{
   // Default constructor
   // Initialisation of TopSVDUnfold
...
//_______________________________________________________________________
TH2D* TopSVDUnfold::GetUnfoldCovMatrix( const TH2D* cov, Int_t ntoys, Int_t seed )
{
...
//_______________________________________________________________________
TH2D* TopSVDUnfold::GetAdetCovMatrix( Int_t ntoys, Int_t seed )
{
...
//_______________________________________________________________________
TH2D* TopSVDUnfold::GetXtau() const 
{ 
...
//_______________________________________________________________________
TH2D* TopSVDUnfold::GetXinv() const 
{ 
...
//_______________________________________________________________________
void TopSVDUnfold::H2V( const TH1D* histo, TVectorD& vec )
{
...
//_______________________________________________________________________
void TopSVDUnfold::H2Verr( const TH1D* histo, TVectorD& vec )
{
...
//_______________________________________________________________________
void TopSVDUnfold::V2H( const TVectorD& vec, TH1D& histo )
{
...
//_______________________________________________________________________
void TopSVDUnfold::H2M( const TH2D* histo, TMatrixD& mat )
{
...
//_______________________________________________________________________
void TopSVDUnfold::M2H( const TMatrixD& mat, TH2D& histo )
{
   // Fill 2D histogram into matrix
...
//_______________________________________________________________________
TVectorD TopSVDUnfold::VecDiv( const TVectorD& vec1, const TVectorD& vec2, Int_t zero )
{
...
//_______________________________________________________________________
TMatrixD TopSVDUnfold::MatDivVec( const TMatrixD& mat, const TVectorD& vec, Int_t zero )
{
...
//_______________________________________________________________________
TVectorD TopSVDUnfold::CompProd( const TVectorD& vec1, const TVectorD& vec2 )
{
...
//_______________________________________________________________________
Double_t TopSVDUnfold::GetCurvature(const TVectorD& vec, const TMatrixD& curv) 
{      
...
//_______________________________________________________________________
void TopSVDUnfold::FillCurvatureMatrix( TMatrixD& tCurv, TMatrixD& tC ) const
{
...
//_______________________________________________________________________
void TopSVDUnfold::RegularisedSymMatInvert( TMatrixDSym& mat, Double_t eps )
{
...
//_______________________________________________________________________
Double_t TopSVDUnfold::ComputeChiSquared( const TH1D& truspec, const TH1D& unfspec)
{
