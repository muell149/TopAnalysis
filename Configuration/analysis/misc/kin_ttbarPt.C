...
// Canvas Style
  ...
  //lese histogramm aus
  myHist1a = (TH1F*)myFile1->Get("analyzeTopGenKinematics/ttbarPt");
  myHist2a = (TH1F*)myFile1->Get("analyzeTopRecKinematics/ttbarPt");
  myHist3a = (TH1F*)myFile1->Get("analyzeTopRecKinematicsMatched/ttbarPt");
