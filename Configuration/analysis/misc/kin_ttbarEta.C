...
// Canvas Style
  ...
  //lese histogramm aus
  myHist1a = (TH1F*)myFile1->Get("analyzeTopGenKinematics/kin_ttbarEta");
  myHist2a = (TH1F*)myFile1->Get("analyzeTopRecKinematics/kin_ttbarEta");
  myHist3a = (TH1F*)myFile1->Get("analyzeTopMatchKinematics/kin_ttbarEta");
