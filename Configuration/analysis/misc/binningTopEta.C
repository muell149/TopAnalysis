...
TH2F* myHist2d;
  ...
  myHist2d = (TH2F*)myFile1->Get("analyzeTopMatchKinematics/kin_genRecTopEta");
...
for (int k=0; k< binN ; k++)
 ...
 TCanvas *a=new TCanvas("2DtopEta","2DtopEta",1);
  // set canvas style 
  gStyle->SetPalette(1);
  myHist2d->Draw("colz");
  myHist2d->GetXaxis()->SetTitle("Top Eta Gen");
  myHist2d->GetYaxis()->SetTitle("Top Eta Rec");
