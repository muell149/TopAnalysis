...
##    + REDIGI38X Trigger Results Tag
##    + REDIGI38X_Mu9 trigger
## ---
...
## trigger details
triggerResultsTagName = "TriggerResults::REDIGI38X"
...
## change output name 
process.TFileService.fileName = 'analyzeMuonZNormAllRedigi38X_Mu9.root'
