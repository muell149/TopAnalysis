...
TopAnalysis/Configuration/analysis/semiLeptonic/jetEnergy/analyze "analyzeJetEnergyCorrections_7TeV_ak5.root" "GenMatch"
...
cp -r analyzeJetEnergyCorrections_7TeV_ak5/    ~/latex/notes/JECTopValidation
