...
process.MessageLogger.categories.append('TtDecaySelection')
...
process.MessageLogger.cerr.INFO = cms.untracked.PSet(
    ...
    TtDecaySelection           = cms.untracked.PSet( limit = cms.untracked.int32(-1) ),
    topFilter                  = cms.untracked.PSet( limit = cms.untracked.int32(-1) ),
...
process.load("TopAnalysis.TopAnalyzer.SemiLepJetCombMVAStudy_electrons_cff")
