...
## choose data set
process.load("TopAnalysis/Configuration/samples/Run2011A_SingleMu_May10ReRecoV1_and_PromptRecoV4_AOD_cff")
...
## change output name 
process.TFileService.fileName = 'analyzeDiffXData2011A_Muon_160404_167913.root'
