...
## choose data set
process.load("TopAnalysis/Configuration/samples/Run2011B_MuHad_PromptRecoV1_175860_180252_AOD_cff")

## choose unprescaled trigger
process.hltFilter.TriggerResultsTag = "TriggerResults::HLT"
process.hltFilter.HLTPaths = ["HLT_IsoMu17_eta2p1_TriCentralJet30_v*", "HLT_IsoMu17_eta2p1_TriCentralPFJet30_v*"]
...
if(writeOutput):
    ...
    process.out.fileName = cms.untracked.string('patTuple_selectedNjets4Btag1_Run2011BPromptRecoV1.root')

## change output name 
process.TFileService.fileName = 'analyzeDiffXDataMuon2011BPromptRecoV1_175860_180252_cfg.root'