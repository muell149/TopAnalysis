...
process.load("TopAnalysis/Configuration/samples/Run2011AEPS_ElectronHad_May10ReRecoV1_and_PromptRecoV4_160404_167913_AOD_cff")
...
process.hltFilter.HLTPaths = ["HLT_Ele25_CaloIdVT_TrkIdT_CentralTriJet30_v*",
    "HLT_Ele25_CaloIdVT_TrkIdT_TriCentralJet30_v3", "HLT_Ele25_CaloIdVT_CaloIsoT_TrkIdT_TrkIsoT_TriCentralJet30_v*"]
...
process.TFileService.fileName = 'analyzeDiffXData2011AEPSCombinedElectron.root'
