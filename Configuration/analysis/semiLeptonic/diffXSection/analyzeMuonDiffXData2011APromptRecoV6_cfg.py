...
## choose data set
process.load("TopAnalysis/Configuration/samples/Run2011A_MuHad_PromptRecoV6_172620_175770_AOD_cff")

## choose unprescaled trigger
process.hltFilter.TriggerResultsTag = "TriggerResults::HLT"
process.hltFilter.HLTPaths = ["HLT_IsoMu17_TriCentralJet30_v*", "HLT_IsoMu17_eta2p1_TriCentralJet30_v*"]
...
if(writeOutput):
    ...
    process.out.fileName = cms.untracked.string('patTuple_selectedNjets4Btag1_Run2011APromptRecoV6.root')

## change output name 
process.TFileService.fileName = 'analyzeDiffXDataMuon2011APromptRecoV6_172620_175770_cfg.root'