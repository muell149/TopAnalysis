...
## enable/ disable MC event weights 
if(not globals().has_key('MCweighting')):
    MCweighting = True # False
    # take care of data
...
print " Apply MC weights:                   ",MCweighting  
...
## ---
##    GOSSIE: combine MC event weights with PU event weights
## ---
...
weightlistMCandPU     .append(PUweight)
weightlistMCandPUUp   .append(PUweightUp)
weightlistMCandPUDown .append(PUweightDown)
...
if(runningOnData=="MC" and PUreweigthing):
    ...
    #print genModules1
    #print genModules2
    # GOSSIE combine MC event weight with PU weight
...
if (runningOnData=="data"):
    for path in allpaths:
        getattr(process,path).remove( process.eventWeightMC )
