...
## JSON file (12 / fb)
jsonFile = 'Cert_190456-203755_8TeV_RunABC_Collisions12_JSON.txt'
...
process.maxEvents.input = 1000 #FIXME: comment out for for testing
...
if(writeOutput):
    ...
    process.out.fileName = cms.untracked.string('patTuple_selectedNjets4NBtags2KinFit_Run2012ABC.root')

## change output name
if(decayChannel == 'muon'):
    process.TFileService.fileName = 'analyzeDiffXData2012ABCMuon.root'
elif(decayChannel == 'electron'):
    process.TFileService.fileName = 'analyzeDiffXData2012ABCElec.root'
