...
## choose data set
process.load("TopAnalysis/Configuration/samples/Run2011A_ElectronHad_May10ReRecoV1_AOD_cff")
...
## change output name 
process.TFileService.fileName = 'analyzeDiffXData2011A_Electron_160404_163869.root'
