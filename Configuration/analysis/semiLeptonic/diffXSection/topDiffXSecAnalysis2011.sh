...
## mkdir -p diffXSecFromSignal/plots/combined/2011/binning
## mkdir -p diffXSecFromSignal/plots/combined/2011/effAndAcc
## mkdir -p diffXSecFromSignal/plots/combined/2011/genRecoCorrPlots
## mkdir -p diffXSecFromSignal/plots/combined/2011/kinFitPerformance
