...
## tight jet selection
bJetCandidates = selectedLayer1Jets.clone(src = 'selectedLayer1Jets', 
                                          cut = 'pt > 40.' 
					        '& abs(eta) < 2.3' 
...
fullLeptonicMuonMuonSelection = cms.Sequence((tightMuons      * muonSelection ) *
                                             #(looseElectrons  * electronVeto  ) *
                                             (bJetCandidates  * jetSelection  )
                                            )
