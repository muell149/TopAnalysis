#ifndef FullLepHypothesesAnalyzerBSM_h
#define FullLepHypothesesAnalyzerBSM_h
...
class FullLepHypothesesAnalyzerBSM : public edm::EDAnalyzer {

 public:

  explicit FullLepHypothesesAnalyzerBSM(const edm::ParameterSet&);
  ~FullLepHypothesesAnalyzerBSM(){};
