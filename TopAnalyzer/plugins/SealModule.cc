...
typedef ObjectAnalyzer<std::vector<pat::Jet>, JetId, JetKinematic, JetResolution>
		JetAnalyzer;
typedef ObjectAnalyzer<std::vector<pat::Muon>, MuonId, MuonKinematic, MuonResolution>
		MuonAnalyzer;
typedef ObjectAnalyzer<std::vector<pat::Electron>, ElecId, ElecKinematic, ElecResolution>
		ElecAnalyzer;
