...
void JetEnergyResolutionBiasAnalyzer::beginJob()
{
  ...
  hists_["respPt_0" ] = fs->make<TH2F>("respPt_0" , "respPt_0" , 13, binningLogPt, 51, 0., 2.);
  hists_["respPt_10"] = fs->make<TH2F>("respPt_10", "respPt_10", 13, binningLogPt, 51, 0., 2.);
  hists_["respPt_20"] = fs->make<TH2F>("respPt_20", "respPt_20", 13, binningLogPt, 51, 0., 2.);
  hists_["respPt_30"] = fs->make<TH2F>("respPt_30", "respPt_30", 13, binningLogPt, 51, 0., 2.);
  hists_["respPt_40"] = fs->make<TH2F>("respPt_40", "respPt_40", 13, binningLogPt, 51, 0., 2.);
  hists_["respPt_50"] = fs->make<TH2F>("respPt_50", "respPt_50", 13, binningLogPt, 51, 0., 2.);

  hists_["respPtSmear_0" ] = fs->make<TH2F>("respPtSmear_0" , "respPtSmear_0" , 13, binningLogPt, 51, 0., 2.);
  hists_["respPtSmear_10"] = fs->make<TH2F>("respPtSmear_10", "respPtSmear_10", 13, binningLogPt, 51, 0., 2.);
  hists_["respPtSmear_20"] = fs->make<TH2F>("respPtSmear_20", "respPtSmear_20", 13, binningLogPt, 51, 0., 2.);
  hists_["respPtSmear_30"] = fs->make<TH2F>("respPtSmear_30", "respPtSmear_30", 13, binningLogPt, 51, 0., 2.);
  hists_["respPtSmear_40"] = fs->make<TH2F>("respPtSmear_40", "respPtSmear_40", 13, binningLogPt, 51, 0., 2.);
  hists_["respPtSmear_50"] = fs->make<TH2F>("respPtSmear_50", "respPtSmear_50", 13, binningLogPt, 51, 0., 2.);
  ...
  hists_["massWPt_0" ] = fs->make<TH2F>("massWPt_0 ", "massWPt_0 ", 13, binningLogPt, 28, 0., 140.);
  hists_["massWPt_10"] = fs->make<TH2F>("massWPt_10", "massWPt_10", 13, binningLogPt, 28, 0., 140.);
  hists_["massWPt_20"] = fs->make<TH2F>("massWPt_20", "massWPt_20", 13, binningLogPt, 28, 0., 140.);
  hists_["massWPt_30"] = fs->make<TH2F>("massWPt_30", "massWPt_30", 13, binningLogPt, 28, 0., 140.);
  hists_["massWPt_40"] = fs->make<TH2F>("massWPt_40", "massWPt_40", 13, binningLogPt, 28, 0., 140.);
  hists_["massWPt_50"] = fs->make<TH2F>("massWPt_50", "massWPt_50", 13, binningLogPt, 28, 0., 140.);

  hists_["massWPtSmear_0" ] = fs->make<TH2F>("massWPtSmear_0 ", "massWPtSmear_0 ", 13, binningLogPt, 28, 0., 140.);
  hists_["massWPtSmear_10"] = fs->make<TH2F>("massWPtSmear_10", "massWPtSmear_10", 13, binningLogPt, 28, 0., 140.);
  hists_["massWPtSmear_20"] = fs->make<TH2F>("massWPtSmear_20", "massWPtSmear_20", 13, binningLogPt, 28, 0., 140.);
  hists_["massWPtSmear_30"] = fs->make<TH2F>("massWPtSmear_30", "massWPtSmear_30", 13, binningLogPt, 28, 0., 140.);
  hists_["massWPtSmear_40"] = fs->make<TH2F>("massWPtSmear_40", "massWPtSmear_40", 13, binningLogPt, 28, 0., 140.);
  hists_["massWPtSmear_50"] = fs->make<TH2F>("massWPtSmear_50", "massWPtSmear_50", 13, binningLogPt, 28, 0., 140.);
  ...
  hists_["massTPt_0" ] = fs->make<TH2F>("massTPt_0 ", "massTPt_0 ", 13, binningLogPt, 60, 0., 300.);
  hists_["massTPt_10"] = fs->make<TH2F>("massTPt_10", "massTPt_10", 13, binningLogPt, 60, 0., 300.);
  hists_["massTPt_20"] = fs->make<TH2F>("massTPt_20", "massTPt_20", 13, binningLogPt, 60, 0., 300.);
  hists_["massTPt_30"] = fs->make<TH2F>("massTPt_30", "massTPt_30", 13, binningLogPt, 60, 0., 300.);
  hists_["massTPt_40"] = fs->make<TH2F>("massTPt_40", "massTPt_40", 13, binningLogPt, 60, 0., 300.);
  hists_["massTPt_50"] = fs->make<TH2F>("massTPt_50", "massTPt_50", 13, binningLogPt, 60, 0., 300.);

  hists_["massTPtSmear_0" ] = fs->make<TH2F>("massTPtSmear_0 ", "massTPtSmear_0 ", 13, binningLogPt, 60, 0., 300.);
  hists_["massTPtSmear_10"] = fs->make<TH2F>("massTPtSmear_10", "massTPtSmear_10", 13, binningLogPt, 60, 0., 300.);
  hists_["massTPtSmear_20"] = fs->make<TH2F>("massTPtSmear_20", "massTPtSmear_20", 13, binningLogPt, 60, 0., 300.);
  hists_["massTPtSmear_30"] = fs->make<TH2F>("massTPtSmear_30", "massTPtSmear_30", 13, binningLogPt, 60, 0., 300.);
  hists_["massTPtSmear_40"] = fs->make<TH2F>("massTPtSmear_40", "massTPtSmear_40", 13, binningLogPt, 60, 0., 300.);
  hists_["massTPtSmear_50"] = fs->make<TH2F>("massTPtSmear_50", "massTPtSmear_50", 13, binningLogPt, 60, 0., 300.);
