...
void TopKinematics::book()
{
  ...
  **/
  ...
  corrs_["topPhi_"     ] = new TH2F( "topPhi_"     ,  "topPhi_"   ,  100, -3.14,  3.14,    100,-3.14,  3.14);
...
void TopKinematics::book(edm::Service<TFileService>& fs)
{
  ...
  **/
  ...
  // gen-rec level correlation top phi
  corrs_["topPhi_"     ] = fs->make<TH2F>( "topPhi_"     ,  "topPhi_"   ,  100, -3.14,  3.14,    100,-3.14,  3.14);
  // gen-rec level correlation ttbar pt
...
void
TopKinematics::fill(const reco::Candidate* leptonicTop, const reco::Candidate* hadronicTop, const double& weight)
{
  /** 
...
void 
TopKinematics::fill(const reco::Candidate* leptonicTopRec, const reco::Candidate* leptonicTopGen, const reco::Candidate* hadronicTopRec, const reco::Candidate* hadronicTopGen, const double& weight)
{
  /** 
      Fill Top Variables for Cross Section Measurement
  **/
