...
void KinFitQuality::book()
{
  ...
  **/
  ...
  // b pt
  hists_["bQuarkPt"     ] = new TH1F( "bQuarkPt"      , "bQuarkPt"      ,   70, -6., 1.  );
  // b eta
  hists_["bQuarkEta"    ] = new TH1F( "bQuarkEta"     , "bQuarkEta"     ,   20, -1., 1.  );
  // b phi
  hists_["bQuarkPhi"    ] = new TH1F( "bQuarkPhi"     , "bQuarkPhi"     ,   63,  0., 6.3 );
  // lightQuark pt
  hists_["lightQuarkPt" ] = new TH1F( "lightQuarkPt"  , "lightQuarkPt"  ,   70, -6., 1.  );
  // lightQuark b eta
  hists_["lightQuarkEta"] = new TH1F( "lightQuarkEta" , "lightQuarkEta" ,   20, -1., 1.  );
  // lightQuark b phi
  hists_["lightQuarkPhi"] = new TH1F( "lightQuarkPhi" , "lightQuarkPhi" ,   63,  0., 6.3 );
...
void KinFitQuality::book(edm::Service<TFileService>& fs)
{
  ...
  **/
  ...
  // b pt
  hists_["bQuarkPt"     ] = fs->make<TH1F>( "bQuarkPt"      , "bQuarkPt"      ,   70, -6., 1.  );
  // b eta
  hists_["bQuarkEta"    ] = fs->make<TH1F>( "bQuarkEta"     , "bQuarkEta"     ,   20, -1., 1.  );
  // b phi
  hists_["bQuarkPhi"    ] = fs->make<TH1F>( "bQuarkPhi"     , "bQuarkPhi"     ,   63,  0., 6.3 );
  // lightQuark pt
  hists_["lightQuarkPt" ] = fs->make<TH1F>( "lightQuarkPt"  , "lightQuarkPt"  ,   70, -6., 1.  );
  // lightQuark b eta
  hists_["lightQuarkEta"] = fs->make<TH1F>( "lightQuarkEta" , "lightQuarkEta" ,   20, -1., 1.  );
  // lightQuark b phi
  hists_["lightQuarkPhi"] = fs->make<TH1F>( "lightQuarkPhi" , "lightQuarkPhi" ,   63, -0., 6.3 );
