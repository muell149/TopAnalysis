...
class HypothesisKinFitJets : public DoubleObject<TtSemiLeptonicEvent, const std::vector<pat::Jet> > {
  ...
  **/
  ...
  void fill(const TtSemiLeptonicEvent& tops, const std::vector<pat::Jet>& jets, const double& weight=1.);
