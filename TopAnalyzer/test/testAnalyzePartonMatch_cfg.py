...
# analyze parton matching
process.load("TopAnalysis.TopAnalyzer.PartonMatchAnalyzer_cff")


## register TFileService
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('analyzePartonMatch.root')
)

process.p1 = cms.Path(process.makePartonMatchAnalysis)
