...
analyzeAllElec = analyzeElec.clone()
analyzeSelElec = analyzeElec.clone()

## reconfigure
analyzeAllElec.input = 'allLayer1Electrons'
analyzeSelElec.input = 'selectedLayer1Electrons'
...
process.p1 = cms.Path(makeWeights    *
                      analyzeAllElec +
                      analyzeSelElec
                      )
