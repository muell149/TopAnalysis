...
## std sequence for tqaf layer2
process.load("TopQuarkAnalysis.TopObjectProducers.tqafLayer2_ttSemiLeptonic_cff")
process.p1 = cms.Path(process.tqafLayer2_ttSemiLeptonic)
...
process.p2 = cms.Path(process.eventWeight    *
