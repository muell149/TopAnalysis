...
process.load("TopAnalysis.TopUtils.QCDBkgMVATreeSaver_cff")
...
from TopAnalysis.TopUtils.QCDBkgMVATreeSaver_cff import looper
process.looper = looper
process.p1 = cms.Path(process.makeGenEvt *
                      process.ttSemiLeptonicFilter * process.loose * process.saveQCDBkgMVATrainTree)
