#ifndef TopAnalysis_TopUtils_plugins_CandidateCleaner_h
#define TopAnalysis_TopUtils_plugins_CandidateCleaner_h
/**
  \class    pat::CandidateCleaner CandidateCleaner.h "TopAnalysis/TopUtils/plugins/CandidateCleaner.h"
  \brief    derived from PAT Cleaner module for PAT Objects
            extended to be useable with gen objects
...
//namespace pat {
  ...
  class CandidateCleaner : public edm::EDProducer {
    public:
      explicit CandidateCleaner(const edm::ParameterSet & iConfig);
      virtual ~CandidateCleaner() {}
...
template <class PATObjType>
CandidateCleaner<PATObjType>::CandidateCleaner(const edm::ParameterSet & iConfig) :
...
template <class PATObjType>
void 
CandidateCleaner<PATObjType>::produce(edm::Event & iEvent, const edm::EventSetup & iSetup) {
