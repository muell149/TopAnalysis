#ifndef GenJetSelector_h
#define GenJetSelector_h
...
/**
   \class   GenJetSelector GenJetSelector.h "TopAnalysis/TopUtils/interface/GenJetSelector.h"
...
class GenJetSelector : public edm::EDProducer {

 public:
  /// default constructor
  explicit GenJetSelector(const edm::ParameterSet&);
  /// default destructor
  ~GenJetSelector(){};
