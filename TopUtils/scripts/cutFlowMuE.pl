...
my @files = ("TopDiLepton_MuEl_Ttbar_MuEl.txt",
             "TopDiLepton_MuEl_Ttbar_MuElViaTau.txt",
	     "TopDiLepton_MuEl_Ttbar_BKG.txt",
	     "TopDiLepton_MuEl_SingleTop_tW.txt",
	     "TopDiLepton_MuEl_WWTo2L2Nu.txt",
	     "TopDiLepton_MuEl_WZTo3LNu.txt",
	     "TopDiLepton_MuEl_ZZToAll.txt",
	     "TopDiLepton_MuEl_WToMuNu.txt",
	     "TopDiLepton_MuEl_WToTauNu.txt",
             "TopDiLepton_MuEl_WToENu.txt",
	     "TopDiLepton_MuEl_DYtautau.txt",
	     "TopDiLepton_MuEl_Ztautau.txt",
	     "TopDiLepton_MuEl_Zjets_tautau.txt",
	     "TopDiLepton_MuEl_DYmumu.txt",
	     "TopDiLepton_MuEl_Zmumu.txt",
	     "TopDiLepton_MuEl_Zjets_mumu.txt",
             
             "TopDiLepton_MuEl_DYee.txt",
             "TopDiLepton_MuEl_Zee.txt",
             "TopDiLepton_MuEl_Zjets_ee.txt",
             
	     "TopDiLepton_MuEl_QCDInclusiveMu15.txt",
	     "TopDiLepton_MuEl_Run2011.txt"
	    );
