...
class CfgRunner:
    def __init__(self):
        self._sleeptime = 6#time in seconds to wait between commands

        #executing path is in most cases the outputpath.
        #you can change it here
        #example: self.filepath = 'outputpath/rootfiles/'
        self.filepath = '' 
        self.fileprefix = 'MatrixMethod_' #modulname will be used as filnameprefix
        self.filesuffix = '.root' #filetype
        
        self.type_ = ''     
        self.numberofevents_ = 0
        
        self.outputfile = 'outputfile.txt'
        self.outputerr = 'erroutput.txt'
        self.runs_ = ""
    ...
    #possible arguments:
        ...
        try:
            opts, args = getopt.getopt(sys.argv[1:], 'ht:e:f:', ['help', 'type=', 'events=', 'file-output='])
