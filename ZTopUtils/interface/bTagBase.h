...
namespace ztop{
  ...
  public:
    ...
    double getEventWeight(const std::vector< ztop::PolarLorentzVector > &, std::vector<int>); //jets.p4 & and jets.genpartonFlavour
    ...
    void setSystematic(int sys){syst_=sys;}
    int getSystematic(){return syst_;}
